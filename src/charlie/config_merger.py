...
def _merge_named_list(
    ...
    # Merge new items, tracking overwrites
...
def merge_configs(base: CharlieConfig, overlay: CharlieConfig, source_name: str = "overlay") -> MergeResult:
    ...
    # Merge assets (simple concatenation with deduplication)
    ...
    # Project from overlay takes precedence (or use base if overlay doesn't have one)
